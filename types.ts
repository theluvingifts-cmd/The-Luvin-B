...
export interface DesignLayer {
    ...
    isLocked: boolean; // Cannot move/resize
    allowContentEdit: boolean; // Can edit text content or replace image
    allowStyleEdit: boolean; // Can change font/color
...
export interface BackgroundTemplate {
    id: string;
    name: string;
    thumbnailUrl: string; // Auto-generated preview
    frameId: string; // Links to specific frame size (e.g. 'lg', 'md')
    layers: DesignLayer[];
    canvasColor: string; // Base background color
    canvasImage?: string; // Base background image
    createdAt: number;
    updatedAt: number;
    tags?: string[];
}