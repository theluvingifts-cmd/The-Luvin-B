            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 mt-6">
                ...
                <div className="space-y-2 text-sm text-gray-700">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-2"><span className="text-gray-500">Hộp quà:</span>{isEditingOrder && (<input type="checkbox" checked={order.addGiftBox} onChange={(e) => handleEditFormChange('addGiftBox', e.target.checked)} className="w-4 h-4 accent-pink-600"/>)}</div>
