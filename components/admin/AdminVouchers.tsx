                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden max-w-2xl mx-auto">
                    ...
                    <div className="p-6 space-y-4">
                        <div>
                            ...
                            <input 
                                className="w-full p-2.5 border border-gray-300 rounded focus:ring-2 focus:ring-gray-900 outline-none font-mono uppercase"
                                value={formData.code}
                        ...
                        <div className="flex items-center gap-2 p-3 bg-gray-50 rounded border border-gray-200">
                            ...
                            />
                            <label htmlFor="isActive" className="text-sm font-bold text-gray-700 cursor-pointer">Kích hoạt mã này</label>
                        </div>
                    </div>
