    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 w-full max-w-3xl mx-auto">
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50 rounded-t-xl">
                <h3 className="text-xl font-bold text-gray-800">{initialData ? 'Sửa Mẫu' : 'Thêm Mẫu Mới'}</h3>
            ...
            <div className="p-6 space-y-4">
                ...
                <div>
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center bg-gray-50 hover:bg-gray-100 relative">
                        ...
                        {isUploading ? <span className="text-xs">Uploading...</span> : formData.imageUrl ? <img src={formData.imageUrl} className="max-h-64 mx-auto object-contain" /> : <span className="text-xs text-gray-400">Chọn ảnh</span>}
                    </div>
                </div>
                <div>
                    ...
                    <textarea 
                        ...
                        className="w-full p-2.5 border border-gray-300 rounded bg-gray-50 text-xs font-mono h-64"
