    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
            ...
            <main className="max-w-[1600px] mx-auto py-4 sm:py-8 px-2 sm:px-6">
                ...
                {activeTab === 'orders' && <AdminOrders orders={orders} setOrders={setOrders} products={products} frames={frames} currentUser={currentUser} role={role} onRefreshProducts={async () => setProducts(await getAllParts())} templates={templates} />}
