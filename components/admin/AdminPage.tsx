...
import { AdminStudio } from '../admin/AdminStudio'; // Added
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
                            ...
                            <nav className="hidden md:flex gap-1 overflow-x-auto no-scrollbar">
                                ...
                                {canManageConfig && (
                                    <>
                                        ...
                                        <button onClick={() => setActiveTab('studio')} className={`px-3 py-1.5 rounded-lg text-sm font-bold transition-all text-purple-700 bg-purple-50 hover:bg-purple-100 ${activeTab === 'studio' ? 'ring-2 ring-purple-300' : ''}`}>Studio Design ✨</button>
                    ...
                    <nav className="flex px-4 gap-4 min-w-max">
                        ...
                        {canManageConfig && (
                            <>
                                ...
                                <button onClick={() => setActiveTab('studio')} className={`py-3 text-sm font-bold border-b-2 transition-all ${activeTab === 'studio' ? 'border-purple-600 text-purple-700' : 'border-transparent text-purple-500 hover:text-purple-800'}`}>Studio</button>
            ...
            <main className="max-w-[1600px] mx-auto py-4 sm:py-8 px-2 sm:px-6">
                ...
                {activeTab === 'studio' && canManageConfig && <AdminStudio />}
            </main>
        </div>
    );
};
