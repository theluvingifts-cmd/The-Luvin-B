        ...
        <div className="flex-grow grid grid-cols-1 md:grid-cols-2 relative">
          ...
          <div className="flex flex-col justify-center items-center p-12 text-center relative overflow-hidden bg-[#fffbf0]">
               ...
               <div className="relative z-10 flex flex-col items-center">
                   ...
                   {/* 3. Modern Button (Redesigned with Flexbox to Fix Overlap) */}
                   <button
                     onClick={() => navigateTo('builder')}
                     className="group relative h-14 bg-black rounded-full flex items-center justify-center px-6 transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] hover:w-[260px] w-[200px] active:scale-95 shadow-xl hover:shadow-2xl overflow-hidden"
                   >
...
const CollectionPage: React.FC<{ 
    ...
    frames: FrameOption[]
}> = ({ navigateTo, onCustomize, templates, onZoomImage, allParts, frames }) => {
    ...
    return ( 
      <div className="min-h-screen bg-[#f9f4ef] pb-20 font-body"> {/* Changed bg to cream */}
